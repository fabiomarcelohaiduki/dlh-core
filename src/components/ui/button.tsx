...
/**
 * Button no padrao shadcn/ui, mapeado aos tokens do Design Lock.
...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-sm whitespace-nowrap rounded-sm text-[13.5px] font-medium transition-colors disabled:pointer-events-none disabled:opacity-45 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-line [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border border-border bg-surface-2 text-fg hover:bg-surface-3 hover:border-[#33333e] active:translate-y-px",
        primary:
          "border border-accent bg-accent font-semibold text-[#1a140a] hover:bg-[#e6a948] hover:border-[#e6a948] active:translate-y-px",
        ghost:
