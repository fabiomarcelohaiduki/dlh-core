...
export function CfgForm({
  ...
  // Poll a cada 5s para refletir coleta iniciada por agendamento/runner. O Salvar
  // NAO trava: serve so para o banner avisando que a config vale na proxima execucao.
