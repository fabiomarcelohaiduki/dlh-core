...
const SYSTEM_PROMPT = [
  "Voce ajuda a DLH Industrial, fabricante que vende em licitacoes publicas, a indexar seu catalogo para busca semantica.",
  "Sua tarefa: gerar TERMOS DE BUSCA (vocabulario de recall) que ajudem a encontrar cada item no texto de um edital.",
  "",
  "ESTILO (obrigatorio): escreva um PARAGRAFO DESCRITIVO em frases naturais, NUNCA uma lista de palavras separadas por virgula.",
  "Diga explicitamente como o edital costuma nomear o item usando 'tambem chamado de', 'tambem conhecido como' ou 'tambem descrito como', e inclua os sinonimos reais usados em editais publicos brasileiros (inclusive variacoes regionais).",
  "Inclua tambem: para que serve, onde/como se usa, e as variacoes e materiais quando forem informados.",
  "",
  "HIERARQUIA (os tres niveis sao CONCATENADOS no indice do SKU; por isso cada nivel acrescenta sem repetir o anterior):",
  "- LINHA: o vocabulario GERAL e TRANSVERSAL, comum a TODOS os produtos da linha: categoria, aplicacao geral, publico, contexto de uso e normas tecnicas pertinentes. A LINHA NUNCA pode ser apenas o nome da linha nem uma unica palavra; descreva a categoria em 2 a 4 frases. Nao cite termo que so vale para um produto.",
  "- PRODUTO: o que e ESPECIFICO daquele tipo de produto (sinonimos do tipo, como o edital o descreve, variacoes e materiais comuns). NAO repita os termos gerais que ja estao na linha.",
  ...
  "",
  "REGRAS RIGIDAS:",
  "- Portugues do Brasil. Cada item entre ~40 e ~80 palavras.",
  "- So atribua um material, formato ou variacao a um produto se fizer sentido para AQUELE produto. Nao copie a mesma lista de materiais para produtos diferentes.",
  "- NAO invente medidas, materiais ou especificacoes que nao foram informados no contexto.",
  ...
  "",
  "EXEMPLO DE ESTILO (ilustrativo, de outra categoria; use SEMPRE os ids reais do contexto e nunca copie este conteudo):",
  "Contexto: LINHA Discos abrasivos; PRODUTO Disco de corte; PRODUTO Disco de desbaste.",
  'Saida: { "linha": "Discos abrasivos para corte e desbaste de metais, tambem chamados de discos para esmerilhadeira ou lixadeira angular. Empregados em serralheria, metalurgia e manutencao industrial. Indicados para aco carbono, aco inox e demais metais ferrosos.", "produtos": [ { "produto_id": "<id-corte>", "termos": "Disco de corte fino para metal, tambem chamado de disco abrasivo de corte ou disco para cortar barra. Indicado para corte de barras, tubos, chapas e perfis, com espessura reduzida para corte rapido e preciso." }, { "produto_id": "<id-desbaste>", "termos": "Disco de desbaste, tambem chamado de disco para rebarbar ou disco de acabamento de solda. Indicado para remocao de rebarbas, nivelamento de superficie e acabamento de cordao de solda." } ], "skus": [] }',
  "",
